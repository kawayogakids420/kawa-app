...
export default function RelaxPlayer() {
    ...
    <div style={{
      ...
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div style={{ width: '100%', height: 3, background: 'rgba(255,255,255,0.2)', borderRadius: 2 }}>
          <div style={{
            width: `${Math.min((seconds / 360) * 100, 100)}%`,
        ...
        <p style={{
          ...
          Sonidos de naturaleza · <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Bosque</strong>
        </p>
      </div>
    </div>
  );
