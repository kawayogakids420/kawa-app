// content/profiles.ts
// Los 4 perfiles sensoriales. "desc" se muestra en Perfil; "tip" en Recursos > Tips.
...
export type SensoryProfile = {
  ...
  tip: string;     // consejo para el adulto
};

export const profiles: Record<ProfileId, SensoryProfile> = {
  'muy-sensible': {
    id: 'muy-sensible', name: 'Muy Sensible', accent: '#C07BA0', tint: '#F7E9F1', image: '/profiles/muy-sensible.png',
  ...
  'buscador': {
    id: 'buscador', name: 'Buscador/a', accent: '#CE9226', tint: '#FBF1D6', image: '/profiles/buscador.png',
  ...
  'bajo-registro': {
    id: 'bajo-registro', name: 'Bajo Registro', accent: '#5F97BA', tint: '#E6F0F6', image: '/profiles/bajo-registro.png',
  ...
  'planif-motora': {
    id: 'planif-motora', name: 'Planif. Motora', accent: '#7E9A7A', tint: '#EAF0E7', image: '/profiles/planif-motora.png',
